...
const clientNav = [
  {
    ...
    icon: <LuLayoutDashboard />,
    match: (path) => path === "/Client" || path === "/client/dashboard",
  },
  {
    label: "Inbox",
    path: "/client/chat",
    icon: <AiOutlineMessage />,
    match: (path) => path === "/client/chat" || path === "/client/chat/:id",
  },
  {
    label: "Jobs",
    ...
    match: (path) =>
      ...
      path === "/client/jobs/completed" ||
      path === "/client/jobs/ongoing",
  },
  /* {
      name: "Transaction",
...
const companyNav = [
  {
    ...
    path: "/company/home",
    icon: <BiHomeAlt2 />,
    match: (path) => path === "/company/home" || path === "/company",
  },
  {
    label: "Inbox",
    path: "/company/chat",
    icon: <AiOutlineMessage />,
    match: (path) => path === "/company/chat",
  },
  {
    label: "Jobs",
    ...
    match: (path) =>
      path === "/company/jobs/bidded" ||
      path === "/company/jobs/ongoing" ||
      path === "/company/jobs/completed",
  },
  /* {
        name: "Transaction",
...
const freelancerNav = [
  {
    ...
    icon: <BiHomeAlt2 />,
    match: (path) => path === "/freelancer/home" || path === "/freelancer",
  },
  {
    label: "Inbox",
    path: "/freelancer/chat",
    icon: <AiOutlineMessage />,
    match: (path) => path === "/freelancer/chat",
  },
  {
    label: "Jobs",
    path: "/freelancer/jobs/bidded",
    icon: <GiWallet />,
    match: (path) => path === "/freelancer/jobs/bidded",
  },
  /* {
        name: "Transaction",
